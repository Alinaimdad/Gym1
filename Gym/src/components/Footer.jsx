...
//               className="h-12 px-4 rounded bg-[#1a1a1a] text-gray-300 border border-gray-600 focus:outline-none w-full md:w-auto"
//             />
//             <button className="h-12 px-6 text-base rounded bg-red-600 hover:bg-red-700 text-white transition-transform hover:scale-105">
//               Subscribe
//             </button>
//           </div>
//         </div>
